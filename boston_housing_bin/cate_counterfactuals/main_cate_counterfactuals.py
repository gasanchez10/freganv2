# CATE Counterfactuals Analysis for Boston Housing (Binary Classification)
...
print("=== CATE COUNTERFACTUALS ANALYSIS FOR BOSTON HOUSING (BINARY) ===")
...
# Create potential outcomes structure (same as synthetic case)
train_potential_y = []
test_potential_y = []
...
# Save all data arrays (same structure as synthetic case)
data_arrays = [
...
fig.suptitle('CATE Counterfactuals Analysis - Boston Housing', fontsize=16, fontweight='bold')
...
# Save correlation results (same as synthetic case)
